...
class Tuban(db.Model):
    ...
    rectify_records = db.relationship(
        "RectifyRecord", backref="tuban", lazy="dynamic", cascade="all, delete-orphan"
    )
    ...
    def to_dict(self):
        ...
        return {
            ...
            "discover_time": self.discover_time.isoformat()
            if self.discover_time
            else None,
            ...
            "rectify_deadline": self.rectify_deadline.isoformat()
            if self.rectify_deadline
            else None,
            "rectify_status": self.rectify_status,
            "rectify_verify_time": self.rectify_verify_time.isoformat()
            if self.rectify_verify_time
            else None,
